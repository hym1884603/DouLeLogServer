...
<el-row class="panel">
	<el-col :span="24" class="panel-top">
		<el-col :span="21" style="font-size:26px;">
			<img src="../assets/logo4.png" class="logo"> <span>Dou<i style="color:#20a0ff">Le</i></span>
		</el-col>
		<el-col :span="2">
			<el-select v-model="config.form.locale" class="language" style="width:120px" placeholder="language">
				<el-option v-for="item in options" :label="item.label" :value="item.value" @click.native="saveConfig">
				</el-option>
			</el-select>
		</el-col>
		<el-col :span="1">
